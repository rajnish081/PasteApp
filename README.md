...
#hiiiii
{
  ...
  "login": {
    "title": "Sign in",
    "subtitle": "Relationship Manager portal",
    "username": "User ID",
    "password": "Password",
    "submit": "Sign in",
  ...
  "customers": {
    "title": "Customers",
    "subtitle": "Manage and analyze your client portfolio relationships.",
  ...
  "statements": {
    ...
    "subtitle": "Select the customer for this statement.",
    ...
    "selectProductsHint": "Choose which holdings to include in this statement.",
    ...
    "from": "From",
    "to": "To",
    "documentLanguage": "Statement Language",
    "outputFormat": "Output Format",
    "reviewTitle": "Review",
    "reviewHint": "Confirm the details before generating.",
    "statementOfAccounts": "Statement of Accounts",
    "readySubtitle": "Your statement is ready to review and send.",
    "generated": "Statement generated successfully.",
    "emailed": "Statement emailed to the customer.",
    "generateAnother": "Generate another"
  },
  "advice": {
    "title": "Generate Advice",
    "subtitle": "Configure product recommendations for client review.",
    "stepDetails": "Details",
    "stepReview": "Review",
    "stepDispatch": "Dispatch",
    "selectCustomer": "SELECT CUSTOMER",
    "searchPlaceholder": "Search by name or ID",
    "productFocus": "SELECT PRODUCT FOCUS",
    "documentSettings": "DOCUMENT SETTINGS",
    "primaryLanguage": "Primary Language",
    "outputFormat": "Output Format",
    "notes": "Notes",
    "notesPlaceholder": "Add any client-specific commentary...",
    "reviewHint": "Confirm the advice details before dispatch.",
    "dispatch": "Dispatch",
    "generated": "Advice generated successfully.",
    "emailed": "Advice emailed to the customer.",
    "generateAnother": "Generate another"
  },
  "status": {
    "active": "Active",
